    ...
    <>
      <Layout preview={false} loading={false}>
        ...
        <ReviewHeader
          ...
          arenas={arenas}
          summary={`We are traveling near and far to every state/country to visit all the NBA and WNBA arenas (${arenas.length}) across the US and Canada. Follow us on this journey.`}
          animation={'/basketball.svg'}
        />

        <div className="container mx-auto   mt-14 grid grid-cols-1  place-content-center place-items-center gap-x-6 gap-y-10  px-3 sm:grid-cols-2 md:grid-cols-2 md:gap-10 md:gap-x-5 md:px-6  lg:grid-cols-3 2xl:grid-cols-4">
          {arenas?.map((item) => (
            <div
              key={item._id}
            ...
            >
              <div className="relative ">
                <div className="absolute left-1/2 top-1/2 z-10 w-full -translate-x-1/2 -translate-y-1/2 transform  ">
                  ...
                  <div className="relative flex items-center  justify-evenly  align-middle text-xs font-bold text-gray-700 dark:text-gray-200 md:text-xs ">
                    <div className="my-4 flex items-center ">
                      <IoHammer className=" h-4 w-4 text-red-50" />
                      <p className="px-1">
                        Constructed in <PostYear dateString={item.buildDate} />
                      </p>
                    </div>
                    <div className="flex items-center gap-1">
                      <FaPersonWalking className=" h-4 w-4 text-red-50" />
                      <p className="px-1">
                        Capacity {new Intl.NumberFormat().format(item.capacity)}
                      </p>
                    </div>
                  </div>

                  <div className="z-10  flex  w-full flex-row items-center justify-center align-middle ">
                ...
                <div className="bg-muted">
                  <img
                    ...
                    className=" h-42  w-full  object-cover object-center brightness-[0.31] md:block  "
                    height={300}
                    width={224}
                    alt={`${item.name} arena`}
                  />
              ...
              <div className=" ml-6  my-2  grid grid-cols-1 items-center gap-y-2  align-middle text-xs font-bold text-gray-700 dark:text-gray-200 md:text-xs ">
