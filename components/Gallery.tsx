...
function Gallery({ posts, heading }: GalleryProps) {
  ...
  return (
    <section className="body-font w-full">
      <div className="mx-6 md:container md:mx-auto py-8 sm:py-12"> {/* Added some vertical padding */}
        <div className="mb-8 flex w-full flex-col font-medium lg:mb-12"> {/* Increased bottom margin */}
        ...
        {images && images.length > 0 ? (
          ...
          >
            {images.map((item, i) => {
              ...
              return (
                <div key={key} className="break-inside-avoid group relative"> {/* Item Wrapper */}
                  {/*
                    Using Next/Image:
