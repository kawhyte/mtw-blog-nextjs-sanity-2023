...
let featuredInstagram = [
  ...
  {
    url: 'https://www.instagram.com/p/CwtyimGOs2X/?next=%2Fmeet_the_whytes%2F&img_index=1',
  },
  {
...
const InstagramHighlights = ({ instagram }) => {
  ...
  return (
    <div className="container mx-auto  rounded-xl bg-yellow-50 px-10 py-12 ">
      ...
      <div className="grid grid-cols-6 justify-items-center gap-5   md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-4">
