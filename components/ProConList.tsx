      ...
      <section className="mx-6 md:mx-0 text-gray-800">
        ...
        <div className="container md:mx-auto flex flex-wrap py-6 lg:py-12">
          <div className=" grid grid-cols-1  gap-6 2xl:grid-cols-3">
            <div className="md:  md:w-full">
              <div className="flex flex-col rounded-lg  border-opacity-50 bg-gradient-to-b from-gray-100 via-gray-200 to-green-100 p-2 md:p-5  ">
                <div className="flex justify-start align-middle ">
                  ...
                  <div className="mx-3 mb-4 inline-flex  h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-green-100 text-green-500  sm:mb-0 sm:mr-8">
                    <svg
                    ...
                    >
                      <ul>
                        {positives?.map((positive, index) => (
                          <li
                            key={index}
                            className={`${inter.variable} my-3  font-secondary text-base font-extralight leading-relaxed md:text-lg`}
                          >
            ...
            <div className=" md:w-full">
              <div className="flex flex-col  rounded-lg  border-opacity-50 bg-gradient-to-r from-indigo-200 via-red-200 to-yellow-100 p-2 md:p-5  ">
                <div className="flex justify-start align-middle ">
                  <h2 className="font-fancy title-font mb-3 pr-3 text-lg font-bold text-gray-900 md:text-2xl">
                    Verdict
                  </h2>
                ...
                <div className="p- grow rounded-xl bg-white">
                  <div
                    className={`${inter.variable} flex  flex-col px-7 font-secondary text-base leading-relaxed sm:items-start lg:text-lg`}
                  >
