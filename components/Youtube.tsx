  ...
  return (
    <>
      ...
      <div className="mx-5 sm:mx-0">
        {/* <div className="mb-10 flex w-full container mx-auto flex-col text-center font-medium lg:mb-12">
          <p
        ...
        <div className="mb-8 flex w-full flex-col  font-medium lg:mb-9">
                  ...
                  <SectionTitle header= {link.title ? link.title : "Video"} description={undefined}></SectionTitle>
        </div>
        

        {/* Use a responsive wrapper with padding-bottom for aspect ratio */}
        <div className="relative container max-w-5xl  mb-12 w-full sm:mx-auto md:mb-24" style={{ paddingBottom: '56.25%' }}> 
