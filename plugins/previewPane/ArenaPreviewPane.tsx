/**
 * This component is responsible for rendering a preview of an arena inside the Studio.
 */
...
export default function ArenaPreviewPane(props: Props) {
  ...
  if (!slug) {
    return (
      <Card tone="primary" margin={5} padding={6}>
        <Text align="center">
          Please add a slug to the arena to see the preview!
        </Text>
      </Card>
    )
  }
...
const Iframe = memo(function Iframe(
  ...
  // IMPORTANT: Ensure this URL matches your frontend's route for individual arenas
  // and that your /api/preview route can handle arena slugs.
  const url = new URL('/api/preview', location.origin)
  url.searchParams.set('slug', slug)
  // Optional: Add a type parameter if your /api/preview needs to know the document type
   url.searchParams.set('type', 'arena');
  if (secret) {
