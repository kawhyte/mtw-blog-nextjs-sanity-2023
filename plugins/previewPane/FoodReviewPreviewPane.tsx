/**
 * This component is responsible for rendering a preview of a food review inside the Studio.
 */
...
export default function FoodReviewPreviewPane(props: Props) {
  ...
  if (!slug) {
    return (
      <Card tone="primary" margin={5} padding={6}>
        <Text align="center">
          Please add a slug to the food review to see the preview!
        </Text>
      </Card>
    )
  }
...
const Iframe = memo(function Iframe(
  ...
  // Set type to 'foodReview' for proper routing
  url.searchParams.set('type', 'foodReview')
