/**
 * This component is responsible for rendering a preview of a travel guide inside the Studio.
 */
...
export default function GuidePreviewPane(props: Props) {
  ...
  if (!slug) {
    return (
      <Card tone="primary" margin={5} padding={6}>
        <Text align="center">
          Please add a slug to the guide to see the preview!
        </Text>
      </Card>
    )
  }
...
const Iframe = memo(function Iframe(
  ...
  // Set type to 'guide' for proper routing
